...
const ShortSummaryReport = () => {
  ...
  const displayColumns = [
    ...
    { key: 'cuttingQty', name: 'Cutting Qty', searchTerms: ['cutting qty', 'total pcs', 'pcs', 'quantity'], width: '110px' },
    { key: 'section', name: 'Section', searchTerms: ['section'], width: '100px' },
    { key: 'season', name: 'Season', searchTerms: ['season'], width: '100px' },
    { key: 'partyName', name: 'Party Name', searchTerms: ['party name', 'party'], width: '120px' },
